---
title: Installation
description: Getting started with eatechUI
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://ui.eatech.dev/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.eatech.dev/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://eatechUI/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.eatech.dev/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.eatech.dev/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.eatech.dev/r/card-05.json
```
...
```jsx
import Card05 from "@/components/eatechUI/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.eatech.dev/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.eatech.dev/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.eatech.dev/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/eatechUI/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://ui.eatech.dev/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://ui.eatech.dev/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.eatech.dev/r/card-05.json -c ./apps/www
```
